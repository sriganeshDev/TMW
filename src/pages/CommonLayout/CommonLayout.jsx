...
//       allowedRoles: ["Admin", "Member"], // Both roles can access
//     },
//     {
//       text: "ToDo",
//       icon: <ChecklistOutlinedIcon />,
//       path: "/smart-HR/todo",
//       allowedRoles: ["Member"], // Both roles can access
//     },
//     {
//       text: "Projects",
//       icon: <FolderOpenOutlinedIcon />,
...
//       icon: <ChecklistIcon />,
//       path: "/smart-HR/tasks",
//       allowedRoles: ["Admin"], // Both roles can access
//     },
//     {
//       text: "Users Management",
//       icon: <GroupOutlinedIcon />,
...
const CommonLayout = () => {
  ...
  // Enhanced state management for sidebar
  const [mobileOpen, setMobileOpen] = useState(false);
  ...
  // Enhanced drawer content with collapse support
  const drawer = (
    <div>
      <Toolbar />
      <List sx={{ px: 1 }}>
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        <Toolbar>
          {/* Universal hamburger menu - works for both mobile and desktop */}
          <IconButton
            color="inherit"
            edge="start"
            onClick={handleDrawerToggle}
      ...
      >
        ...
        {/* Desktop Drawer with collapse functionality */}
        <Drawer
          variant="permanent"
          sx={{
            display: { xs: "none", md: "block" },
